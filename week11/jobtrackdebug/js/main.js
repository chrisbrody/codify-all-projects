...
function newTracker(){
	...
	var newApply = new JobsApplied(company,dateApplied,response,notes)
...
document.getElementById('newTracker').addEventListeners('click', newTracker, false);

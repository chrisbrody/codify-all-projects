...
btn.addEventListeners('click', displayCard, false);
...
function displayCard() {
  ...
  var cardImg = document.createElements('img');
  ...
  // update HTML to display new deck length
  document.getElementsById("totalCards").textContent = "Total Cards Left: " + deck.length;
